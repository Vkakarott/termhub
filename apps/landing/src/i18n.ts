...
const pt = {
  ...
  cloud: {
    badge: 'beta gratuito',
    title: 'termhub Cloud',
    lead: 'A mesma experiência, sem servidor para manter: suas máquinas conectam ao termhub Cloud e você acessa de qualquer lugar. Está em beta gratuito: inscreva-se para receber o acesso.',
    perks: ['Sem Docker, sem proxy, sem túnel: conecte a máquina e pronto', 'Login e allowlist prontos, com times e permissões', 'Aviso no celular quando o Claude precisar de você', 'Grátis durante o beta, com acesso em ordem de inscrição'],
    form: {
      title: 'Entrar no beta gratuito',
      first: 'Nome',
      last: 'Sobrenome',
      email: 'E-mail (Gmail)',
      ...
      submit: 'Quero participar do beta',
      sending: 'Enviando…',
      done_title: 'Inscrição recebida!',
      done_text: 'Você está inscrito. Avisamos por e-mail quando o seu acesso ao beta sair.',
      already: 'Este e-mail já está inscrito no beta.',
      error: 'Não foi possível enviar agora. Tente de novo em instantes.',
      privacy: 'Usamos seus dados só para o acesso ao beta do termhub Cloud.',
    },
  },
  agents: {
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'É grátis?', a: 'Sim. O termhub é open source sob licença MIT: rode na sua rede com quantas máquinas e usuários quiser. O termhub Cloud, hospedado por nós, está em beta gratuito e depois será a opção paga para quem não quer manter servidor.' },
      { q: 'O que é o termhub Cloud?', a: 'A mesma experiência sem servidor para manter: você conecta suas máquinas com o agente e acessa de qualquer lugar, com login, times e permissões prontos. Está em beta gratuito, e o acesso é liberado em ordem de inscrição.' },
...
const en: typeof pt = {
  ...
  cloud: {
    badge: 'free beta',
    title: 'termhub Cloud',
    lead: 'The same experience with no server to maintain: your machines connect to termhub Cloud and you reach them from anywhere. It is in free beta: sign up to get access.',
    perks: ['No Docker, no proxy, no tunnel: connect the machine and go', 'Sign-in and allowlist built in, with teams and permissions', 'A ping on your phone when Claude needs you', 'Free during the beta, with access in sign-up order'],
    form: {
      ...
      sending: 'Sending…',
      done_title: 'You’re signed up!',
      done_text: 'We will e-mail you when your beta access is ready.',
      already: 'This e-mail is already signed up for the beta.',
      error: 'Could not send right now. Please try again in a moment.',
      privacy: 'We only use your data for your termhub Cloud beta access.',
    },
  },
  agents: {
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'Is it free?', a: 'Yes. termhub is open source under the MIT license: run it on your network with as many machines and users as you like. termhub Cloud, hosted by us, is in free beta and will later be the paid option for those who do not want to maintain a server.' },
      { q: 'What is termhub Cloud?', a: 'The same experience with no server to maintain: you connect your machines with the agent and reach them from anywhere, with sign-in, teams and permissions built in. It is in free beta, and access is granted in sign-up order.' },
